# Upload new setup script using SQLite3
...
Upload-FtpFile -localFile "$localPath\api\config\setup-databases.php" -remoteFile "$remotePath/api/config/setup-databases.php"
Write-Host "`nNow visit: https://vpn.the-truth-publishing.com/api/config/setup-databases.php" -ForegroundColor Cyan
