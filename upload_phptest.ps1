...
Upload-FtpFile -localFile "$localPath\phptest.php" -remoteFile "$remotePath/phptest.php"
Write-Host "`nNow visit: https://vpn.the-truth-publishing.com/phptest.php" -ForegroundColor Cyan
